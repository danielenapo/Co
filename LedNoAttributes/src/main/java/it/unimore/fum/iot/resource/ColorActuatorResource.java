 ...
 */
public class ColorActuatorResource extends CoapResource {

	private static final String OBJECT_TITLE = "ColorActuator";
	private Gson gson;
	private ColorDescriptor modeDescriptor;
	private String deviceId = null;
	private static final Number SENSOR_VERSION = 0.1;

	public ColorActuatorResource(String name, String deviceId) {
		super(name);
	...
	private void init(){
        ...
        this.gson = new Gson();
		this.modeDescriptor = new ColorDescriptor();

		setObservable(true);
		setObserveType(CoAP.Type.CON);

		getAttributes().setTitle("Color");
		getAttributes().addAttribute("rt", "it.unimore.color");
