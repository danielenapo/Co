...
public class SliderActuatorResource extends CoapResource {
    private final String deviceId;
    private Gson gson;
    private SliderDescriptor sliderDescriptor;

    public SliderActuatorResource(String name, String deviceId) {
        super(name);
    ...
    public void handleGET(CoapExchange exchange) {
        try{
            ...
            if(exchange.getRequestOptions().getAccept() == MediaTypeRegistry.APPLICATION_SENML_JSON ||
                ...
                exchange.respond(CoAP.ResponseCode.CONTENT, String.valueOf(this.sliderDescriptor.toString()), MediaTypeRegistry.TEXT_PLAIN);
        }catch (Exception e){
            exchange.respond(CoAP.ResponseCode.INTERNAL_SERVER_ERROR);
        }
    }
    ...
    private Optional<String> getJsonSenmlResponse(){
        ...
        try{
            ...
            senMLRecord.setV(this.sliderDescriptor.getValue());
    ...
    public void handlePOST(CoapExchange exchange) {
        try{
            this.sliderDescriptor.setValue( exchange.getRequestText());
